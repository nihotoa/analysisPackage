...
def main():
    ...
    for i in range(len(files)):
        ...
        if i == 0:
            ...
            roiX2, roiY2, roiW, roiH, ledTh2, searchColor2, trimFrame_pre, trimFrame_post, trimType = paramSet.trimming_LED(fName,frame_1st_process)
        ...
        if trimType == 0:
            ...
            startFrame, endFrame,trialNum = movieAnalysis.LEDdetection_reverse(fName,videoPath[i],savePath,trigFrame,trigEndFrame,rotAngle,gamma,roiX2,roiY2,roiW,roiH,ledTh2,searchColor2,trimFrame_pre,trimFrame_post)
