...
def trimming_LED(filename,frame):
    ...
    cv2.createTrackbar("Type","ParamSet3",trimtype,1,onTrackbar14)
    ...
    return roiX2, roiY2, roiW, roiH, ledTh2, search_color2, trimframe_pre, trimframe_post, trimtype
...
def onTrackbar14(position):
    global trimType
    trimType = position
    display("Trimming typeB: " + str(trimType))