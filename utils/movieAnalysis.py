...
def LEDdetection_reverse(filename,videofile_path,savefile_path,trigframe,trigEnd_frame,rotAngle,gamma,roiX2,roiY2,roiW,roiH,ledTh2,searchColor2,trimFrame_pre,trimFrame_post):
    # Initialization
    startframe = []
    endframe = []
    duration = []
    ...
    if len(startframe) > len(endframe):
        endframe.append(frameNum)
